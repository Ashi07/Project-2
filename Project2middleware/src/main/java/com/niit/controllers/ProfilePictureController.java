...
public class ProfilePictureController {
	...
	public ResponseEntity<?> addprofilepicture(@RequestParam CommonsMultipartFile image,HttpSession session)
	{
		...
		profileDao.uploadProfilePicture(profilePicture);
	...
	public @ResponseBody byte[] getProfilePicture(@RequestParam String email,HttpSession session){
		...
		ProfilePicture profilePicture=profileDao.getProfilePicture(email);
